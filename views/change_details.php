    ...
    <div style="background-image: linear-gradient(to left,  #fec007de, rgba(255, 255, 255, 0)), url(<?php echo Router::base_url().'/files/icons/undraw_Profile_data_re_v81r.png'?>);">
        <div class="container">   
                <div class="block">
