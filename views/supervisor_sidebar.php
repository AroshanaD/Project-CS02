    ...
    <div class="sidebar">
            <div>
                <div style="margin-left: var(--small-margin);"><img src='home.png' style="width:20px; height: 20px; "><a href=<?php echo Router::site_url().'/user/dashboard' ?>>Dashboard</a> </div><br>
                    <div class="dropdown">
                        <div style="margin-left: var(--small-margin);"><img src='home.png' style="width:20px; height: 20px; ">  Manage staff</div>
                    ...
                    <div class="dropdown">
                        <div style="margin-left: var(--small-margin);"><img src='user.png' style="width:20px; height: 20px; ">  Manage Doctors</div>
                        <div class="dropdown-content">
                    ...
                    <div class="dropdown">
                        <div style="margin-left: var(--small-margin);"><img src='lock.png' style="width:20px; height: 20px; ">  Manage inventory</div>
                        <div class="dropdown-content">
                    ...
                    <div class="dropdown">
                        <div style="margin-left: var(--small-margin);"><img src='logout.png' style="width:20px; height: 20px; ">  Manage vendors</div>
                        <div class="dropdown-content">
                    ...
                    <div class="dropdown">
                        <div style="margin-left: var(--small-margin);"><img src='logout.png' style="width:20px; height: 20px; ">  Manage Schedules</div>
                        <div class="dropdown-content">
