    ...
    <div style="background-image: linear-gradient(to left,  oldlace, rgba(255, 255, 255, 0)), url(<?php echo Router::base_url().'/files/icons/undraw_medical_care_movn.png'?>);">
        <div class="container">
                <div class="block">
                    ...
                    <?php $_POST['id']=$record['id'] ?>
                       <div class="form-box">
                           <div class="title">Delete Lab Test</div>
                            ...
                            <div class="btn-area"><input type="submit" value="Delete" class="submit-btn" name="Delete"></div>
                        </div >
                    </form>
                    <?php endforeach; ?>
                <?php endif; ?>
